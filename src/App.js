...
import { RPC, nftABI, nftAddress, chainID } from "./components/config";
...
class App extends React.Component {
  ...
  async caputureWallet() {
    if (window.ethereum) {
      ...
      let linkedNFTContract = new clientWeb3.eth.Contract(nftABI, nftAddress);
  ...
  async mint() {
    ...
    await this.state.nftContract.methods
      ...
      <div className="App">
        ...
        <Box id="body">
          <div style={{ display: "flex", flexDirection: "row" }}>
            ...
            <div style={{ width: "30%" }}>
              ...
              <div style={{ backgroundColor: "#000000" }}>
                <h6
                  style={{ fontSize: "2vw", color: "#ffffff", margin: "0.1em" }}
                >
                  Supply : 2000
                </h6>
                <h6
            ...
            <div style={{ width: "56%", paddingTop: "10vh" }}>
              <h6
                style={{ fontSize: "2.8vw", color: "#ffffff", margin: "0.1em" }}
              >
                Freddie’s Crew Mint
              </h6>{" "}
              <br />
              ...
              >
                When you own a Freddie's Crew NFT, you are holding an identity
                proving your membership in the Crew. Being part of the Crew will
                keep give you exclusive access to The Basement.
              </h6>
              <br />
              <h6
                style={{
              ...
              >
                Each member of Freddie's Crew is programmed and generated from
                around 100 traits through different layers. While each member of
                the Crew is unique, some traits are programmed to be rarer than
                others
              </h6>
              <br />
              <h6
              ...
              >
                {this.state.mintedAmount} / 2000 Minted
              </h6>
              <div>
                <br />
                <Slider
          ...
          >
            <BottomNavigationAction
              label="Instagram"
              href="https://www.instagram.com/freddiescrew/"
              target="_blank"
              color="secondary"
              style={{ color: "white" }}
              icon={<Instagram style={{ color: "white" }} fontSize="large" />}
            />
            <BottomNavigationAction
              label="Twitter"
              href="https://www.twitter.com/freddies_Crew"
              target="_blank"
              color="secondary"
              style={{ color: "white" }}
              icon={<Twitter style={{ color: "white" }} fontSize="large" />}
            />
            <BottomNavigationAction
              label="Website"
              href="https://www.freddiescrew.com"
              target="_blank"
              color="secondary"
              style={{ color: "white" }}
              icon={<Language style={{ color: "white" }} fontSize="large" />}
            />
            <BottomNavigationAction
              label="Discord"
              href="https://discord.gg/freddiescrew"
              target="_blank"
              color="secondary"
              style={{ color: "white" }}
              icon={<BsDiscord style={{ color: "white" }} fontSize="33px" />}
            />
          </BottomNavigation>
        </Box>
      </div>
