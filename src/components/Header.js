...
class Header extends React.Component {
  ...
  goToLink() {
    window.open(
      "https://etherscan.io/address/" + this.props.linkedAccount,
      "_blank"
    );
  }
        ...
        >
          ...
          >
            ...
            >
              ...
              <Typography sx={{ color: "#fff", fontFamily: "Pompiere" }}>
                {" "}
                &nbsp; WALLET CONNECT
              </Typography>
            </IconButton>
            ...
            >
              ...
              <Typography sx={{ ml: 2, textTransform: "initial" }}>
                {this.props.linkedAccount.slice(0, 7)}...
                {this.props.linkedAccount.slice(35, 42)}{" "}
              </Typography>
            </Button>
            <Menu
              id="basic-menu"
            ...
            >
              ...
              >
                <BiLinkExternal /> &nbsp; View in Explorer
              </MenuItem>
              <MenuItem
                onClick={() => {
